...
class PatientLogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val openStatusMenu = {
            ...
            popup.menu.add("PENDING_REVIEW")
            popup.menu.add("APPROVED")
            popup.menu.add("NEEDS_REVISION")
    ...
    private fun renderPatientResults(
        ...
        patients.forEachIndexed { index, patient ->
            ...
            val statusView = TextView(this).apply {
                ...
                text = "STATUS: ${(patient.assessmentStatus ?: "PENDING_REVIEW").uppercase()}"
                ...
                background = getDrawable(
                    when {
                        patient.assessmentStatus.equals("NEEDS_REVISION", ignoreCase = true) -> R.drawable.bg_chip_red
                        patient.assessmentStatus.equals("APPROVED", ignoreCase = true) -> R.drawable.bg_chip_green
    ...
    private fun renderCaseSummary(
        ...
        metrics.addView(buildMetaColumn("STATUS", patient.assessmentStatus ?: "DRAFT"))
    ...
    private fun openReport(report: AssessmentReportResponse) {
        showInAppReportDialog(
            ...
            doctor = report.generatedByName ?: "Dr. Sujith Kumar"
        )
    }
